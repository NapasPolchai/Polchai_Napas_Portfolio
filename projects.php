...
$projectQuery = 'SELECT p.project_id, m.file_url, p.project_title, p.project_description FROM projects p JOIN media m ON p.project_id = m.project_id AND p.project_id =' . $_GET['id'];
$projects = $db->query($projectQuery);
?>
